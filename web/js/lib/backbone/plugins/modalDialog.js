...
define(function(require) {
  ...
  Backbone.ModalView = Backbone.View.extend({
    ...
    click: function (event) {
      if (event.target.id == "maskpopup" && this.options.backgroundClickClosesModal) {
        this.hideModal();
      }
    },
    ...
    showModal: function (options) {
      ...
      modalContainer.css({
        "opacity": 0,
        "position": "absolute",
        "z-index": 8000}); // correction "temporaire" select2 (on attendant une correction dans les CSS)
